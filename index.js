  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 6 }}>
      <svg width="180" height="120" viewBox="0 0 180 120">
        ...
        {value ? (
          <>
            <text x={cx} y={cy - 8} textAnchor="middle" fill={activeColor} fontSize="28"
              fontWeight="900" fontFamily="Courier New, monospace">{value}%</text>
            <text x={cx} y={cy + 12} textAnchor="middle" fill="#3d6b4f" fontSize="9"
              fontFamily="Courier New, monospace">DEPTH</text>
          </>
        ) : (
      ...
      {value === 5 && (
        <div style={{ fontSize: 9, color: "#ef4444", letterSpacing: "0.1em", textTransform: "uppercase" }}>
...
const chip = { background: "#0e1f14", border: "1px solid #1e3d28", borderRadius: 20, padding: "3px 10px", fontSize: 10, color: "#5a9b72", letterSpacing: "0.06em" };
...
export default function Home() {
  ...
  return (
    <>
      <style global jsx>{`
        html, body { margin: 0; padding: 0; background: #080f0a; }
